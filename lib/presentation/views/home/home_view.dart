...
import 'package:peacock_and_quill/presentation/views/home/home_content_web.dart';
import 'package:peacock_and_quill/presentation/views/home/home_content_mobile.dart';
...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView(
      child: (kIsWeb)
          ? HomeContentWeb(storageRepository: storageRepository)
