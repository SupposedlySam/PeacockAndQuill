...
import 'package:peacock_and_quill/data/repositories/firestore/storage_repository_mobile.dart'
    if (dart.library.html) 'package:peacock_and_quill/data/repositories/firestore/storage_repository_web.dart';
